...
const SEED_PRODUCTS = [
  ...
  { id: 9, name: "Petits concombres", category: "Légumes", price: 0.5, stock: 12, unit: "pièce", emoji: "🥒"},
  { id: 10, name: "Moyens concombres", category: "Légumes", price: 0.8, stock: 45, unit: "pièce", emoji: "🥒"},
  { id: 13, name: "Oignons blancs", category: "Légumes", price: 1.2, stock: 10, unit: "pièce", emoji: "🧅"},
  { id: 13, name: "Oignons rouges", category: "Légumes", price: 1.2, stock: 10, unit: "pièce", emoji: "🧅"},
  { id: 14, name: "Tomates petit calibre", category: "Légumes", price: 4.5, stock: 6, unit: "kg", emoji: "🍅"},
  { id: 14, name: "Tomates moyen calibre", category: "Légumes", price: 4.5, stock: 30, unit: "kg", emoji: "🍅"},
  { id: 15, name: "Tomates gros calibre", category: "Légumes", price: 4.5, stock: 6, unit: "kg", emoji: "🍅"},
  { id: 16, name: "Tomates coeur de boeuf", category: "Légumes", price: 5, stock: 5, unit: "kg", emoji: "🍅"},
  { id: 12, name: "Persil plat", category: "Autres", price: 1.5, stock: 5, unit: "botte", emoji: "🌿"},
  { id: 12, name: "Laurier feuilles", category: "Autres", price: 1, stock: 5, unit: "branche", emoji: "🌿"},
  { id: 12, name: "Estragon", category: "Autres", price: 1.5, stock: 5, unit: "kg", emoji: "🌿"},
  { id: 12, name: "Basilic", category: "Autres", price: 1.5, stock: 5, unit: "bouquet", emoji: "🌿"},
