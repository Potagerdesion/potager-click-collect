...
const INITIAL_PRODUCTS = [
  { id: 1, name: "Courgettes vertes", category: "Légumes", price: 2.5, stock: 3, unit: "kg", emoji: "🥒" },
  { id: 2, name: "Courgettes rondes", category: "Légumes", price: 3, stock: 5, unit: "kg", emoji: "🥒" },
  { id: 3, name: "Courgettes jaunes", category: "Légumes", price: 2.5, stock: 0, unit: "kg", emoji: "🥒" },
  { id: 13, name: "Carottes", category: "Légumes", price: 2.5, stock: 0, unit: "botte", emoji: "🥕" },
  { id: 4, name: "Salades vertes", category: "Légumes", price: 1.8, stock: 10, unit: "pièce", emoji: "🥗", desc: "Batavia, laitue, mesclun selon saison" },
  { id: 5, name: "Tétragone cornue (épinard d'été)", category: "Légumes", price: 4, stock: 10, unit: "le sac (environ 500g)", emoji: "🥬" },
  { id: 20, name: "Poirées", category: "Légumes", price: 2, stock: 20, unit: "botte", emoji: "🥬" },
  { id: 6, name: "Concombres Noa", category: "Légumes", price: 1, stock: 5, unit: "pièce", emoji: "🥒" },
  { id: 7, name: "Moyens concombres", category: "Légumes", price: 1.2, stock: 10, unit: "pièce", emoji: "🥒" },
  { id: 8, name: "Oignons blancs", category: "Légumes", price: 0.6, stock: 10, unit: "pièce", emoji: "🧅" },
  { id: 22, name: "Oignons jaunes", category: "Légumes", price: 0.6, stock: 10, unit: "pièce", emoji: "🧅" },
  { id: 9, name: "Oignons rouges", category: "Légumes", price: 0.6, stock: 10, unit: "pièce", emoji: "🧅" },
  { id: 10, name: "Tomates cerises", category: "Légumes", price: 4.5, stock: 0, unit: "kg", emoji: "🍅" },
  ...
  { id: 23, name: "Poivrons rouges et verts", category: "Légumes", price: 1.2, stock: 10, unit: "pièces", emoji: "🫑" },
  { id: 24, name: "Piments de Cayenne", category: "Autres", price: 0.5, stock: 30, unit: "pièce", emoji: "🌶️" },
  { id: 26, name: "Piments d'Espelette", category: "Autres", price: 0.5, stock: 30, unit: "pièce", emoji: "🌶️" },
  { id: 27, name: "Piments Thaï", category: "Autres", price: 0.5, stock: 30, unit: "pièce", emoji: "🌶️" },
  { id: 14, name: "Persil plat", category: "Autres", price: 1.5, stock: 5, unit: "botte", emoji: "🌿" },
  { id: 25, name: "Poivre de Sichuan", category: "Autres", price: 4, stock: 5, unit: "le pot", emoji: "🌿" },
